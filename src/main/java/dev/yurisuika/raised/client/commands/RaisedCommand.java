                        ...
                        .then(ClientCommandManager.argument("name", LayerArgument.layer())
                                .then(ClientCommandManager.literal("displacement")
                                        .then(ClientCommandManager.literal("x")
                                                .executes(commandContext -> {
                                                    ...
                                                    commandContext.getSource().sendFeedback(new TranslatableComponent("commands.raised.layer.displacement.x.query", name, Configure.getDisplacementX(name)));
                                                    return 1;
                                                })
                                                .then(ClientCommandManager.argument("x", IntegerArgumentType.integer(0))
                                                        .executes(commandContext -> {
                                                            ...
                                                            commandContext.getSource().sendFeedback(new TranslatableComponent("commands.raised.layer.displacement.x.set", name, Configure.getDisplacementX(name)));
                                                            return 1;
                                                        })
                                                )
                                        )
                                        .then(ClientCommandManager.literal("y")
                                                .executes(commandContext -> {
                                                    String name = LayerArgument.getLayer(commandContext, "name").toString();
                                                    commandContext.getSource().sendFeedback(new TranslatableComponent("commands.raised.layer.displacement.y.query",name, Configure.getDisplacementY(name)));
                                                    return 1;
                                                })
                                                .then(ClientCommandManager.argument("y", IntegerArgumentType.integer(0))
                                                        .executes(commandContext -> {
                                                            ...
                                                            commandContext.getSource().sendFeedback(new TranslatableComponent("commands.raised.layer.displacement.y.set", name, Configure.getDisplacementY(name)));
                                                            return 1;
                                                        })
                                                )
                                        )
                                ...
                                .then(ClientCommandManager.literal("direction")
                                        .then(ClientCommandManager.literal("x")
                                                .executes(commandContext -> {
                                                    String name = LayerArgument.getLayer(commandContext, "name").toString();
                                                    commandContext.getSource().sendFeedback(new TranslatableComponent("commands.raised.layer.direction.x.query", name, new TranslatableComponent(Configure.getDirectionX(name).getKey())));
                                                    return 1;
                                                })
                                                .then(ClientCommandManager.argument("x", DirectionArgument.X.x())
                                                        .executes(commandContext -> {
                                                            ...
                                                            commandContext.getSource().sendFeedback(new TranslatableComponent("commands.raised.layer.direction.x.set", name, new TranslatableComponent(Configure.getDirectionX(name).getKey())));
                                                            return 1;
                                                        })
                                                )
                                        )
                                        .then(ClientCommandManager.literal("y")
                                                .executes(commandContext -> {
                                                    String name = LayerArgument.getLayer(commandContext, "name").toString();
                                                    commandContext.getSource().sendFeedback(new TranslatableComponent("commands.raised.layer.direction.y.query", name, new TranslatableComponent(Configure.getDirectionY(name).getKey())));
                                                    return 1;
                                                })
                                                .then(ClientCommandManager.argument("y", DirectionArgument.Y.y())
                                                        .executes(commandContext -> {
                                                            ...
                                                            commandContext.getSource().sendFeedback(new TranslatableComponent("commands.raised.layer.direction.y.set", name, new TranslatableComponent(Configure.getDirectionY(name).getKey())));
                                                            return 1;
                                                        })
                                                )
                                        )
                                ...
                                .then(ClientCommandManager.literal("sync")
                                        .executes(commandContext -> {
                                            String name = LayerArgument.getLayer(commandContext, "name").toString();
                                            commandContext.getSource().sendFeedback(new TranslatableComponent("commands.raised.layer.sync.query", name, Configure.getSync(name)));
                                            return 1;
                                        })
                                        .then(ClientCommandManager.argument("sync", LayerArgument.layer())
                                                .executes(commandContext -> {
                                                    ...
                                                    commandContext.getSource().sendFeedback(new TranslatableComponent("commands.raised.layer.sync.set", name, Configure.getSync(name)));
                                                    return 1;
                                                })
                                        )
                                )
