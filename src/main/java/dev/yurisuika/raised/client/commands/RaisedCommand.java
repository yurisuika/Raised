                        ...
                        .then(Commands.argument("name", LayerArgument.layer())
                                .then(Commands.literal("displacement")
                                        .then(Commands.literal("x")
                                                .executes(commandContext -> {
                                                    ...
                                                    commandContext.getSource().sendSuccess(() -> Component.translatable("commands.raised.layer.displacement.x.query", name, Option.getDisplacementX(name)), false);
                                                    return 1;
                                                })
                                                .then(Commands.argument("x", IntegerArgumentType.integer(0))
                                                        .executes(commandContext -> {
                                                            ...
                                                            commandContext.getSource().sendSuccess(() -> Component.translatable("commands.raised.layer.displacement.x.set", name, Option.getDisplacementX(name)), false);
                                                            return 1;
                                                        })
                                                )
                                        )
                                        .then(Commands.literal("y")
                                                .executes(commandContext -> {
                                                    String name = LayerArgument.getLayer(commandContext, "name").toString();
                                                    commandContext.getSource().sendSuccess(() -> Component.translatable("commands.raised.layer.displacement.y.query",name, Option.getDisplacementY(name)), false);
                                                    return 1;
                                                })
                                                .then(Commands.argument("y", IntegerArgumentType.integer(0))
                                                        .executes(commandContext -> {
                                                            ...
                                                            commandContext.getSource().sendSuccess(() -> Component.translatable("commands.raised.layer.displacement.y.set", name, Option.getDisplacementY(name)), false);
                                                            return 1;
                                                        })
                                                )
                                        )
                                ...
                                .then(Commands.literal("direction")
                                        .then(Commands.literal("x")
                                                .executes(commandContext -> {
                                                    String name = LayerArgument.getLayer(commandContext, "name").toString();
                                                    commandContext.getSource().sendSuccess(() -> Component.translatable("commands.raised.layer.direction.x.query", name, Component.translatable(Option.getDirectionX(name).getKey())), false);
                                                    return 1;
                                                })
                                                .then(Commands.argument("x", DirectionArgument.X.x())
                                                        .executes(commandContext -> {
                                                            ...
                                                            commandContext.getSource().sendSuccess(() -> Component.translatable("commands.raised.layer.direction.x.set", name, Component.translatable(Option.getDirectionX(name).getKey())), false);
                                                            return 1;
                                                        })
                                                )
                                        )
                                        .then(Commands.literal("y")
                                                .executes(commandContext -> {
                                                    String name = LayerArgument.getLayer(commandContext, "name").toString();
                                                    commandContext.getSource().sendSuccess(() -> Component.translatable("commands.raised.layer.direction.y.query", name, Component.translatable(Option.getDirectionY(name).getKey())), false);
                                                    return 1;
                                                })
                                                .then(Commands.argument("y", DirectionArgument.Y.y())
                                                        .executes(commandContext -> {
                                                            ...
                                                            commandContext.getSource().sendSuccess(() -> Component.translatable("commands.raised.layer.direction.y.set", name, Component.translatable(Option.getDirectionY(name).getKey())), false);
                                                            return 1;
                                                        })
                                                )
                                        )
                                ...
                                .then(Commands.literal("sync")
                                        .executes(commandContext -> {
                                            String name = LayerArgument.getLayer(commandContext, "name").toString();
                                            commandContext.getSource().sendSuccess(() -> Component.translatable("commands.raised.layer.sync.query", name, Option.getSync(name)), false);
                                            return 1;
                                        })
                                        .then(Commands.argument("sync", LayerArgument.layer())
                                                .executes(commandContext -> {
                                                    ...
                                                    commandContext.getSource().sendSuccess(() -> Component.translatable("commands.raised.layer.sync.set", name, Option.getSync(name)), false);
                                                    return 1;
                                                })
                                        )
                                )
