...
public class LayerList extends ContainerObjectSelectionList<LayerList.Entry> {
    ...
    public static class Entry extends ContainerObjectSelectionList.Entry<Entry> {
        ...
        public LayerButton createLayerButton(String name) {
            ...
            }, name.equals(RaisedScreen.current.toString())).size(screen.BUTTON_WIDTH, screen.BUTTON_HEIGHT).texture(ResourceLocation.tryParse("raised:textures/gui/icon/" + texture + ".png"), screen.BUTTON_HEIGHT).tooltip((button, poseStack, mouseX, mouseY) -> screen.renderTooltip(poseStack, Component.literal(name), mouseX, mouseY)).build();
        }
