...
public class LayerList extends ContainerObjectSelectionList<LayerList.Entry> {
    ...
    public static class Entry extends ContainerObjectSelectionList.Entry<Entry> {
        ...
        public LayerButton createLayerButton(String name) {
            ...
            }, name.equals(RaisedScreen.current.toString())).size(screen.BUTTON_WIDTH, screen.BUTTON_HEIGHT).texture(ResourceLocation.tryParse("raised:icon/" + texture), screen.BUTTON_HEIGHT).tooltip(Tooltip.create(Component.literal(name))).build();
        }
