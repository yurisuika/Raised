...
public class LayerList extends ContainerObjectSelectionList<LayerList.Entry> {
    ...
    public static class Entry extends ContainerObjectSelectionList.Entry<Entry> {
        ...
        public LayerButton createLayerButton(ResourceLocation name) {
            ...
            }, name.equals(RaisedScreen.current)).size(screen.BUTTON_WIDTH, screen.BUTTON_HEIGHT).texture(ResourceLocation.tryParse("raised:textures/gui/icon/" + texture + ".png"), screen.BUTTON_HEIGHT).tooltip(Tooltip.create(Component.literal(name.toString()))).build();
        }
