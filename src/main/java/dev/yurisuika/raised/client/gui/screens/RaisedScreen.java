    ...
    public void render(PoseStack poseStack, int mouseX, int mouseY, float partialTick) {
        ...
        switch (element) {
            ...
            case PLAYERS -> {
                ...
                RenderSystem.setShaderTexture(0, ResourceLocation.tryParse("textures/entity/player/wide/steve.png"));
                PlayerFaceRenderer.draw(poseStack, -91 + 1 + 1, offset - 1 - 9 - 9, 8, true, false);
                RenderSystem.setShaderTexture(0, ResourceLocation.tryParse("textures/entity/player/slim/alex.png"));
