...
public abstract class AbstractLayersScreen extends AbstractRaisedScreen {
    ...
    public abstract static class AbstractLayerList<E extends AbstractLayerList.Entry<E>> extends AdjustableSelectionList<E> {
        ...
        public abstract static class Entry<E extends AbstractLayerList.Entry<E>> extends AdjustableSelectionList.Entry<E> {
            ...
            public Entry(Identifier layerName) {
                ...
                optionAnchor = CycleButton.builder(Layer.Anchor::glyph, Config.getOptions().getLayers().get(layerName.toString()).getAnchor())
            ...
            public abstract boolean handleClick(final MouseButtonEvent event);
