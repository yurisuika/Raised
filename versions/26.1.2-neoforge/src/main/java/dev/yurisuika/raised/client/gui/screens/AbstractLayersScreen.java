...
public abstract class AbstractLayersScreen extends AbstractRaisedScreen {
    ...
    public abstract static class AbstractLayerList<E extends AbstractLayerList.Entry<E>> extends SpacedSelectionList<E> {
        ...
        public abstract static class Entry<E extends AbstractLayerList.Entry<E>> extends SpacedSelectionList.Entry<E> {
            ...
            public Entry(Identifier layerName) {
                ...
                optionAnchor = CycleButton.builder(Layer.Anchor::glyph, Configure.Layers.getAnchor(layerName.toString()))
