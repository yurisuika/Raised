        ...
        dispatcher.register(Commands.literal("raised")
                ...
                .then(Commands.literal("additionalSettings")
                        .then(Commands.literal("hotbarSelectionFix")
                                .executes(commandContext -> {
                                    commandContext.getSource().sendSuccess(() -> Component.translatable("commands.raised.additional_settings.hotbar_selection_fix.query", Config.getOptions().getAdditionalSettings().getHotbarSelectionFix().caption()), false);
                                    return 1;
                                })
                                .then(Commands.argument("texture", HotbarSelectionFixArgument.hotbarSelectionFix())
                                        .executes(commandContext -> {
                                            ...
                                            commandContext.getSource().sendSuccess(() -> Component.translatable("commands.raised.additional_settings.hotbar_selection_fix.set", Config.getOptions().getAdditionalSettings().getHotbarSelectionFix().caption()), false);
                                            return 1;
                                        })
                                )
                        )
