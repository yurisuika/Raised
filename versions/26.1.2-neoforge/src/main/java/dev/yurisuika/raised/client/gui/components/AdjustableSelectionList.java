...
public abstract class AdjustableSelectionList<E extends AdjustableSelectionList.Entry<E>> extends ContainerObjectSelectionList<E> {
    ...
    public AdjustableSelectionList(Minecraft minecraft, int width, int height, int y, int itemHeight, int paddingX, int paddingY) {
    ...
    public void extractWidgetRenderState(GuiGraphicsExtractor guiGraphics, int mouseX, int mouseY, float partialTick) {
        ...
        extractListItems(guiGraphics, mouseX, mouseY, partialTick);
    ...
    @Override
    public void extractListItems(GuiGraphicsExtractor guiGraphics, int mouseX, int mouseY, float partialTick) {
        for (E entry : children()) {
    ...
    public abstract static class Entry<E extends AdjustableSelectionList.Entry<E>> extends ContainerObjectSelectionList.Entry<E> {
