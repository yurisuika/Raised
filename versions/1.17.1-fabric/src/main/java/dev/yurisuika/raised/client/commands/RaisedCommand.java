                                                        ...
                                                        .then(ClientCommandManager.argument("layer", LayerArgument.layer())
                                                                ...
                                                                .then(ClientCommandManager.literal("anchor")
                                                                        .executes(commandContext -> {
                                                                            String group = GroupArgument.getGroup(commandContext, "group");
                                                                            String layer = LayerArgument.getLayer(commandContext, "layer").toString();
                                                                            commandContext.getSource().sendFeedback(new TranslatableComponent("commands.raised.layer.options.anchor.query", layer, group, Config.getOptions().getGroups().get(group).getLayers().get(layer).getAnchor().caption()));
                                                                            return 1;
                                                                        })
                                                                        .then(ClientCommandManager.argument("anchor", AnchorArgument.anchor())
                                                                                .executes(commandContext -> {
                                                                                    ...
                                                                                    commandContext.getSource().sendFeedback(new TranslatableComponent("commands.raised.layer.options.anchor.set", layer, group, Config.getOptions().getGroups().get(group).getLayers().get(layer).getAnchor().caption()));
                                                                                    return 1;
                                                                                })
                                                                        )
                                                                )
