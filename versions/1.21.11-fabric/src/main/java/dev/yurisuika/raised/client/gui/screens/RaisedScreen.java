...
public class RaisedScreen extends Screen {
    ...
    public class LayerList extends SpacedSelectionList<LayerList.Entry> {
        ...
        public void setLayers() {
            clearEntries();
            LayerRegistry.LAYERS.keySet().stream().sorted(Comparator.comparing(Identifier::toString)).filter(location -> location.getNamespace().equals(RaisedScreen.current.getNamespace())).forEach(name -> addEntry(new Entry(name)));
        }
