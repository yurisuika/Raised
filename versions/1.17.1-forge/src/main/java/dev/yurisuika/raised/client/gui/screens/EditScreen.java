...
public class EditScreen extends AbstractListScreen {
    ...
    public void render(PoseStack poseStack, int mouseX, int mouseY, float partialTick) {
        ...
        if (leftList.hovered != null) {
            AbstractWidget widget = leftList.hovered.optionAnchor;
            if (widget.isMouseOver(mouseX, mouseY)) {
        ...
        public class Entry extends AdjustableWidgetSelectionList.Entry<Entry> {
            ...
            public Entry(ResourceLocation layerName) {
                ...
                optionAnchor = CycleButton.builder(Layer.Anchor::glyph)
                        ...
                        .displayOnlyValue()
                        .withTooltip(value -> Minecraft.getInstance().font.split(new TranslatableComponent("options.raised.anchor.tooltip", new TranslatableComponent("options.raised.anchor." + value.getSerializedName())), 200))
                        .create(0,
                                0,
                                ENTRY_INNER,
                                ENTRY_INNER,
