...
public class Layer {
    ...
    public enum Anchor implements StringRepresentable {
        ...
        public static final Codec<Anchor> CODEC = StringRepresentable.fromEnum(Anchor::values, Anchor::valueOf);
        ...
        Anchor(String name, String key, String glyph, int x, int y) {
            ...
            this.glyph = new TextComponent(glyph).withStyle(style -> style.withFont(new ResourceLocation(Raised.MOD_ID, "anchor")));
            this.x = x;
            this.y = y;
        }
