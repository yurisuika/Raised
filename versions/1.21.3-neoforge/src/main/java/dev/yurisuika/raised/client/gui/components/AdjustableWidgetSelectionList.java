...
public abstract class AdjustableWidgetSelectionList<E extends AdjustableWidgetSelectionList.Entry<E>> extends ContainerObjectSelectionList<E> {
    ...
    public AdjustableWidgetSelectionList(Minecraft minecraft, int width, int height, int y, int itemHeight, int paddingX, int paddingY) {
    ...
    public void renderWidget(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTick) {
        ...
        if (scrollbarVisible()) {
            ...
            guiGraphics.blitSprite(RenderType::guiTextured, ResourceLocation.withDefaultNamespace("widget/scroller_background"), i, getY(), 6, getHeight());
            guiGraphics.blitSprite(RenderType::guiTextured, ResourceLocation.withDefaultNamespace("widget/scroller"), i, k, 6, j);
