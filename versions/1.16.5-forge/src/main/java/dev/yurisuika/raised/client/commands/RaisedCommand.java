                                                        ...
                                                        .then(Commands.argument("layer", LayerArgument.layer())
                                                                ...
                                                                .then(Commands.literal("anchor")
                                                                        .executes(commandContext -> {
                                                                            String group = GroupArgument.getGroup(commandContext, "group");
                                                                            String layer = LayerArgument.getLayer(commandContext, "layer").toString();
                                                                            commandContext.getSource().sendSuccess(new TranslatableComponent("commands.raised.layer.options.anchor.query", layer, group, Config.getOptions().getGroups().get(group).getLayers().get(layer).getAnchor().caption()), false);
                                                                            return 1;
                                                                        })
                                                                        .then(Commands.argument("anchor", AnchorArgument.anchor())
                                                                                .executes(commandContext -> {
                                                                                    ...
                                                                                    commandContext.getSource().sendSuccess(new TranslatableComponent("commands.raised.layer.options.anchor.set", layer, group, Config.getOptions().getGroups().get(group).getLayers().get(layer).getAnchor().caption()), false);
                                                                                    return 1;
                                                                                })
                                                                        )
                                                                )
