                                ...
                                .then(Commands.argument("group", GroupArgument.group())
                                        .then(Commands.literal("offset")
                                                .then(Commands.literal("x")
                                                        .executes(commandContext -> {
                                                            String group = GroupArgument.getGroup(commandContext, "group");
                                                            commandContext.getSource().sendSuccess(new TranslatableComponent("commands.raised.group.settings.offset.x.query", group, Config.getOptions().getGroups().get(group).getOffset().getX()), false);
                                                            return 1;
                                                        })
                                                        .then(Commands.argument("x", IntegerArgumentType.integer(0))
                                                                .executes(commandContext -> {
                                                                    ...
                                                                    commandContext.getSource().sendSuccess(new TranslatableComponent("commands.raised.group.settings.offset.x.set", group, Config.getOptions().getGroups().get(group).getOffset().getX()), false);
                                                                    return 1;
                                                                })
                                                        )
                                                )
                                                .then(Commands.literal("y")
                                                        .executes(commandContext -> {
                                                            String group = GroupArgument.getGroup(commandContext, "group");
                                                            commandContext.getSource().sendSuccess(new TranslatableComponent("commands.raised.group.settings.offset.y.query",group, Config.getOptions().getGroups().get(group).getOffset().getY()), false);
                                                            return 1;
                                                        })
                                                        .then(Commands.argument("y", IntegerArgumentType.integer(0))
                                                                .executes(commandContext -> {
                                                                    ...
                                                                    commandContext.getSource().sendSuccess(new TranslatableComponent("commands.raised.group.settings.offset.y.set", group, Config.getOptions().getGroups().get(group).getOffset().getY()), false);
                                                                    return 1;
                                                                })
                                                        )
                                                )
                                        ...
                                        .then(Commands.literal("layers")
                                                .executes(commandContext -> {
                                                    ...
                                                    if (layers.isEmpty()) {
                                                        commandContext.getSource().sendFailure(new TranslatableComponent("commands.raised.group.settings.layers.query.error", group));
                                                        return 0;
                                                    } else {
                        ...
                        .then(Commands.literal("settings")
                                .then(Commands.argument("layer", LayerArgument.layer())
                                        .then(Commands.literal("anchor")
                                                .executes(commandContext -> {
                                                    String layer = LayerArgument.getLayer(commandContext, "layer").toString();
                                                    commandContext.getSource().sendSuccess(new TranslatableComponent("commands.raised.layer.settings.anchor.query", layer, Config.getOptions().getLayers().get(layer).getAnchor().caption()), false);
                                                    return 1;
                                                })
                                                .then(Commands.argument("anchor", AnchorArgument.anchor())
                                                        .executes(commandContext -> {
                                                            ...
                                                            commandContext.getSource().sendSuccess(new TranslatableComponent("commands.raised.layer.settings.anchor.set", layer, Config.getOptions().getLayers().get(layer).getAnchor().caption()), false);
                                                            return 1;
                                                        })
                                                )
                                        )
