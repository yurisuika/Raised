                                ...
                                .then(Commands.argument("name", StringArgumentType.string())
                                        .executes(commandContext -> {
                                            ...
                                            if (Config.getOptions().getGroups().containsKey(name)) {
                                                commandContext.getSource().sendFailure(new TranslatableComponent("commands.raised.group.add.error", name));
                                                return 0;
                                            } else {
                                ...
                                .then(Commands.argument("group", GroupArgument.group())
                                        .executes(commandContext -> {
                                            ...
                                            if (!Config.getOptions().getGroups().containsKey(group)) {
                                                commandContext.getSource().sendFailure(new TranslatableComponent("commands.raised.group.remove.error", group));
                                                return 0;
                                            } else {
                                ...
                                .then(Commands.argument("group", GroupArgument.group())
                                        .then(Commands.argument("name", StringArgumentType.string())
                                                .executes(commandContext -> {
                                                    ...
                                                    String name = StringArgumentType.getString(commandContext, "name");
                                                    if (Config.getOptions().getGroups().containsKey(name)) {
                                                        commandContext.getSource().sendFailure(new TranslatableComponent("commands.raised.group.rename.error", name));
                                                        return 0;
                                                    } else {
                                ...
                                .then(Commands.argument("group", GroupArgument.group())
                                        .then(Commands.literal("offset")
                                                .then(Commands.literal("x")
                                                        .executes(commandContext -> {
                                                            String group = GroupArgument.getGroup(commandContext, "group");
                                                            commandContext.getSource().sendSuccess(new TranslatableComponent("commands.raised.group.options.offset.x.query", group, Config.getOptions().getGroups().get(group).getOffset().getX()), false);
                                                            return 1;
                                                        })
                                                        .then(Commands.argument("x", IntegerArgumentType.integer(0))
                                                                .executes(commandContext -> {
                                                                    ...
                                                                    commandContext.getSource().sendSuccess(new TranslatableComponent("commands.raised.group.options.offset.x.set", group, Config.getOptions().getGroups().get(group).getOffset().getX()), false);
                                                                    return 1;
                                                                })
                                                        )
                                                )
                                                .then(Commands.literal("y")
                                                        .executes(commandContext -> {
                                                            String group = GroupArgument.getGroup(commandContext, "group");
                                                            commandContext.getSource().sendSuccess(new TranslatableComponent("commands.raised.group.options.offset.y.query", group, Config.getOptions().getGroups().get(group).getOffset().getY()), false);
                                                            return 1;
                                                        })
                                                        .then(Commands.argument("y", IntegerArgumentType.integer(0))
                                                                .executes(commandContext -> {
                                                                    ...
                                                                    commandContext.getSource().sendSuccess(new TranslatableComponent("commands.raised.group.options.offset.y.set", group, Config.getOptions().getGroups().get(group).getOffset().getY()), false);
                                                                    return 1;
                                                                })
                                                        )
                                                )
                                        ...
                                        .then(Commands.literal("layer")
                                                .executes(commandContext -> {
                                                    ...
                                                    if (layers.isEmpty()) {
                                                        commandContext.getSource().sendFailure(new TranslatableComponent("commands.raised.layer.query.error", group));
                                                        return 0;
                                                    } else {
                                                        commandContext.getSource().sendSuccess(new TranslatableComponent("commands.raised.layer.query", group, layers.toString()), false);
                                                        return 1;
                                                    }
                                                })
                                                .then(Commands.literal("add")
                                                        .then(Commands.argument("layer", LayerArgument.layer())
                                                                .executes(commandContext -> {
                                                                    ...
                                                                    if (Config.getOptions().getGroups().get(group).getLayers().containsKey(layer)) {
                                                                        commandContext.getSource().sendFailure(new TranslatableComponent("commands.raised.layer.add.error", group, layer));
                                                                        return 0;
                                                                    } else {
                                                                        ...
                                                                        commandContext.getSource().sendSuccess(new TranslatableComponent("commands.raised.layer.add", layer, group), false);
                                                                        return 1;
                                                                    }
                                                                })
                                                        )
                                                ...
                                                .then(Commands.literal("remove")
                                                        .then(Commands.argument("layer", LayerArgument.layer())
                                                                ...
                                                                .executes(commandContext -> {
                                                                    ...
                                                                    String layer = LayerArgument.getLayer(commandContext, "layer").toString();
                                                                    if (!Config.getOptions().getGroups().get(group).getLayers().containsKey(layer)) {
                                                                        commandContext.getSource().sendFailure(new TranslatableComponent("commands.raised.layer.remove.error", group, layer));
                                                                        return 0;
                                                                    } else {
                                                                        Config.update(o -> o.getGroups().get(group).getLayers().remove(layer));
                                                                        commandContext.getSource().sendSuccess(new TranslatableComponent("commands.raised.layer.remove", layer, group), false);
                                                                        return 1;
                                                                    }
                                                                })
                                                        )
                                                        ...
                                                        .then(Commands.argument("layer", LayerArgument.layer())
                                                                ...
                                                                .then(Commands.literal("position")
                                                                        .executes(commandContext -> {
                                                                            String group = GroupArgument.getGroup(commandContext, "group");
                                                                            String layer = LayerArgument.getLayer(commandContext, "layer").toString();
                                                                            commandContext.getSource().sendSuccess(new TranslatableComponent("commands.raised.layer.options.position.query", layer, group, Config.getOptions().getGroups().get(group).getLayers().get(layer).getPosition().caption()), false);
                                                                            return 1;
                                                                        })
                                                                        .then(Commands.argument("position", PositionArgument.position())
                                                                                .executes(commandContext -> {
                                                                                    ...
                                                                                    commandContext.getSource().sendSuccess(new TranslatableComponent("commands.raised.layer.options.position.set", layer, group, Config.getOptions().getGroups().get(group).getLayers().get(layer).getPosition().caption()), false);
                                                                                    return 1;
                                                                                })
                                                                        )
                                                                )
