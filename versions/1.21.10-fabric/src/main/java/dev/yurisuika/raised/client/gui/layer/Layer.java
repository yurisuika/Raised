...
public class Layer {
    ...
    public enum Anchor implements StringRepresentable {
        ...
        Anchor(String name, String key, String glyph, int x, int y) {
            ...
            this.glyph = Component.literal(glyph).withStyle(style -> style.withFont(new FontDescription.Resource(ResourceLocation.fromNamespaceAndPath(Raised.MOD_ID, "anchor"))));
            this.x = x;
            this.y = y;
        }
