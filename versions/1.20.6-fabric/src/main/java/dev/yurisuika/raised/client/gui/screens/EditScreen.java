...
public class EditScreen extends AbstractListScreen {
    ...
    public class SelectedLayerList extends AdjustableWidgetSelectionList<SelectedLayerList.Entry> {
        ...
        public class Entry extends AdjustableWidgetSelectionList.Entry<Entry> {
            ...
            @Override
            public int getWidth() {
                return width - (SelectedLayerList.this.scrollbarVisible() ? 6 : 0);
            }
            ...
            public void render(GuiGraphics guiGraphics, int index, int top, int left, int width, int height, int mouseX, int mouseY, boolean hovering, float partialTick) {
                ...
                if (hovering) {
                    guiGraphics.blitSprite(
                            new ResourceLocation(Raised.MOD_ID, "layer_list/unselect" + (i < ENTRY_HEIGHT ? "_highlighted" : "")),
                            left,
                            top,
                            ENTRY_HEIGHT,
                            ENTRY_HEIGHT);
    ...
    public class AvailableLayerList extends AdjustableSelectionList<AvailableLayerList.Entry> {
        ...
        public class Entry extends AdjustableSelectionList.Entry<Entry> {
            ...
            @Override
            public int getWidth() {
                return width - (AvailableLayerList.this.scrollbarVisible() ? 6 : 0);
            }
            ...
            public void render(GuiGraphics guiGraphics, int index, int top, int left, int width, int height, int mouseX, int mouseY, boolean hovering, float partialTick) {
                ...
                if (hovering) {
                    guiGraphics.blitSprite(
                            new ResourceLocation(Raised.MOD_ID, "layer_list/select" + (i < ENTRY_HEIGHT ? "_highlighted" : "")),
                            left,
                            top,
                            ENTRY_HEIGHT,
                            ENTRY_HEIGHT);
