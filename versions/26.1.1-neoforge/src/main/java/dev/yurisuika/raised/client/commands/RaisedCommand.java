        ...
        dispatcher.register(Commands.literal("raised")
                        ...
                        .then(Commands.argument("name", LayerArgument.layer())
                                ...
                                .then(Commands.literal("direction")
                                        .then(Commands.literal("x")
                                                .executes(commandContext -> {
                                                    String name = LayerArgument.getLayer(commandContext, "name").toString();
                                                    commandContext.getSource().sendSuccess(() -> Component.translatable("commands.raised.layer.direction.x.query", name, Configure.getDirectionX(name).caption()), false);
                                                    return 1;
                                                })
                                                .then(Commands.argument("x", DirectionArgument.X.x())
                                                        .executes(commandContext -> {
                                                            ...
                                                            commandContext.getSource().sendSuccess(() -> Component.translatable("commands.raised.layer.direction.x.set", name, Configure.getDirectionX(name).caption()), false);
                                                            return 1;
                                                        })
                                                )
                                        )
                                        .then(Commands.literal("y")
                                                .executes(commandContext -> {
                                                    String name = LayerArgument.getLayer(commandContext, "name").toString();
                                                    commandContext.getSource().sendSuccess(() -> Component.translatable("commands.raised.layer.direction.y.query", name, Configure.getDirectionY(name).caption()), false);
                                                    return 1;
                                                })
                                                .then(Commands.argument("y", DirectionArgument.Y.y())
                                                        .executes(commandContext -> {
                                                            ...
                                                            commandContext.getSource().sendSuccess(() -> Component.translatable("commands.raised.layer.direction.y.set", name, Configure.getDirectionY(name).caption()), false);
                                                            return 1;
                                                        })
                                                )
                                        )
                ...
                .then(Commands.literal("resource")
                        .then(Commands.literal("texture")
                                .executes(commandContext -> {
                                    commandContext.getSource().sendSuccess(() -> Component.translatable("commands.raised.resource.texture.query", Configure.getTexture().caption()), false);
                                    return 1;
                                })
                                .then(Commands.argument("texture", TextureArgument.texture())
                                        .executes(commandContext -> {
                                            ...
                                            commandContext.getSource().sendSuccess(() -> Component.translatable("commands.raised.resource.texture.set", Configure.getTexture().caption()), false);
                                            return 1;
                                        })
                                )
                        )
