...
public abstract class AdjustableWidgetSelectionList<E extends AdjustableWidgetSelectionList.Entry<E>> extends ContainerObjectSelectionList<E> {
    ...
    public AdjustableWidgetSelectionList(Minecraft minecraft, int width, int height, int y0, int y1, int itemHeight, int paddingX, int paddingY) {
    ...
    public void render(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTick) {
        ...
        if (getMaxScroll() > 0) {
            ...
            guiGraphics.fill(i, k, i + 6, k + j, -8355712);
            guiGraphics.fill(i, k, i + 6 - 1, k + j - 1, -4144960);
