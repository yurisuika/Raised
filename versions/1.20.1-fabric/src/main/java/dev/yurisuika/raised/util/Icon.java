...
public class Icon {
    ...
    public static void checkResources() {
        ...
        Minecraft.getInstance().getResourcePackRepository().openAllSelected().forEach(pack -> {
            LayerRegistry.LAYERS.forEach((name, layer) -> {
                ResourceLocation location = new ResourceLocation("raised", "textures/gui/layer/" + name.getNamespace() + "/" + name.getPath() + ".png");
    ...
    public static ResourceLocation getLayerIcon(ResourceLocation name) {
        return TEXTURES.getOrDefault(name, new ResourceLocation("raised", "textures/gui/layer/default.png"));
    }
