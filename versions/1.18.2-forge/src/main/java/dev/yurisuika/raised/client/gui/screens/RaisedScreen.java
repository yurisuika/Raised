...
import dev.yurisuika.raised.mixin.minecraft.client.OptionInvoker;
    ...
    public class LayerList extends SpacedSelectionList<LayerList.Entry> {
        ...
        public class Entry extends SpacedSelectionList.Entry<Entry> {
            ...
            public Component getNarration() {
                return new TranslatableComponent("narrator.select", Parse.parsePath(name));
            }
