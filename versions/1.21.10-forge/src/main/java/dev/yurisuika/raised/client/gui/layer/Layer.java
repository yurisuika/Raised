...
public class Layer {
    ...
    public enum Position implements StringRepresentable {
        ...
        Position(String name, String key, String glyph, int x, int y) {
            ...
            this.glyph = Component.literal(glyph).withStyle(style -> style.withFont(new FontDescription.Resource(ResourceLocation.fromNamespaceAndPath(Raised.MOD_ID, "position"))));
            this.x = x;
            this.y = y;
        }
