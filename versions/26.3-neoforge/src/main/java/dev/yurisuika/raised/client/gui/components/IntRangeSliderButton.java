...
public final class IntRangeSliderButton extends AbstractSliderButton {
    ...
    private final Function<Integer, Tooltip> tooltip;
    ...
    public void setValue(int value) {
        super.setValue(normalize(value, min, max));
    }

    @Override
    protected void updateMessage() {
        setMessage(Component.empty().append(label).append(Component.literal(": ")).append(valueText.apply(getValue())));

        if (tooltip != null) {
            setTooltip(tooltip.apply(getValue()));
        }
    }
    ...
    public static final class Builder {
        ...
        private Function<Integer, Component> valueText = value -> Component.literal(String.format(value.toString()));

        private Function<Integer, Tooltip> tooltip;
        ...
        public Builder tooltip(Function<Integer, Tooltip> tooltip) {
