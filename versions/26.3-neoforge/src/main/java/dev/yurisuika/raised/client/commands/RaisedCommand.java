    ...
    public static void register(CommandDispatcher<CommandSourceStack> dispatcher, CommandBuildContext context) {
        dispatcher.register(Commands.literal("raised")
                                                        ...
                                                        .then(Commands.argument("layer", LayerArgument.layer())
                                                                ...
                                                                .then(Commands.literal("position")
                                                                        .executes(commandContext -> {
                                                                            String group = GroupArgument.getGroup(commandContext, "group");
                                                                            String layer = LayerArgument.getLayer(commandContext, "layer").toString();
                                                                            commandContext.getSource().sendSuccess(() -> Component.translatable("commands.raised.layer.options.position.query", layer, group, Config.getOptions().getGroups().get(group).getLayers().get(layer).getPosition().caption()), false);
                                                                            return 1;
                                                                        })
                                                                        .then(Commands.argument("position", PositionArgument.position())
                                                                                .executes(commandContext -> {
                                                                                    ...
                                                                                    commandContext.getSource().sendSuccess(() -> Component.translatable("commands.raised.layer.options.position.set", layer, group, Config.getOptions().getGroups().get(group).getLayers().get(layer).getPosition().caption()), false);
                                                                                    return 1;
                                                                                })
                                                                        )
                                                                )
                ...
                .then(Commands.literal("settings")
                        .then(Commands.literal("selectionIndicator")
                                .executes(commandContext -> {
                                    commandContext.getSource().sendSuccess(() -> Component.translatable("commands.raised.settings.selection_indicator.query", Config.getOptions().getSettings().getSelectionIndicator().caption()), false);
                                    return 1;
                                })
                                .then(Commands.argument("selectionIndicator", SelectionIndicatorArgument.selectionIndicator())
                                        .executes(commandContext -> {
                                            ...
                                            commandContext.getSource().sendSuccess(() -> Component.translatable("commands.raised.settings.selection_indicator.set", Config.getOptions().getSettings().getSelectionIndicator().caption()), false);
                                            return 1;
                                        })
                                )
                        )
